...
<body>
    ...
    <h1>TAMIL NADU TOURIST SPOTS</h1>
    <div class="grid">
        ...
        <div class="card">
            ...
            <div class="card-content">
                ...
                <p>Kapaleeshwarar Temple is a historic and vibrant Hindu temple in Chennai, dedicated to Lord Shiva and known for its stunning Dravidian architecture.</p>
                <hr>
                <div class="list">
                    <ul>
        ...
        <div class="card">
            <img src="VIVEKANANDAROCK-TAMIL.jpg" alt="IMG">
            <div class="card-content">
                <h3>VIVEKANANDA ROCK</h3>
                <p>Vivekananda Rock Memorial is a famous monument in Kanyakumari, built in honor of Swami Vivekananda, who meditated there in 1892.</p>
                <hr>
                <div class="list">
                    <ul>
                        <li>Round Trip Flights</li>
        ...
        <div class="card">
            <img src="MADURAIMEENAKSHITEMPLE-TAMIL.cms" alt="IMG">
            <div class="card-content">
                <h3>MADURA MEENAKSHI TEMPLE</h3>
                <p>The Madurai Meenakshi Temple is a historic and majestic Hindu temple in Tamil Nadu, dedicated to Goddess Meenakshi and known for its stunning Dravidian architecture.</p>
                <hr>
                <div class="list">
                    <ul>
                        <li>Round Trip Flights</li>
        ...
        <div class="card">
            <img src="KANCHIPURAMCITYOFTEMPLES-TAMIL.avif" alt="IMG">
            <div class="card-content">
                <h3>KANCHIPURAM CITY OF TEMPLES</h3>
                <p>Kanchipuram, known as the "City of Temples," is a historic town in Tamil Nadu famous for its ancient temples and rich cultural heritage.</p>
                <hr>
                <div class="list">
                    <ul>
                        <li>Round Trip Flights</li>
        ...
        <div class="card">
            <img src="OOTY-TAMIL.avif" alt="IMG">
            <div class="card-content">
                <h3>OOTY</h3>
                <p>Ooty, also known as the "Queen of Hill Stations," is a picturesque hill town in Tamil Nadu, famous for its cool climate, tea gardens, and scenic landscapes.</p>
                <hr>
                <div class="list">
                    <ul>
                        <li>Round Trip Flights</li>
        ...
        <div class="card">
            <img src="MARINABEACH-TAMIL.webp" alt="IMG">
            <div class="card-content">
                <h3>MARINA BEACH</h3>
                <p>

                    Marina Beach in Chennai, Tamil Nadu, India, is a natural urban beach along the Bay of Bengal, stretching approximately 13 kilometers, making it one of the longest urban beaches in the world. </p>
                <hr>
                <div class="list">
                    <ul>
                        <li>Round Trip Flights</li>
